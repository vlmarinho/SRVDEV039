/* sp_helptext edited by Davy Machado to avoid unexpected break lines */

create procedure [dbo].[pr_DBA_helptext]
...
*/
,@SyscomText	varchar(6000)
,@Line          varchar(8000)

select @DefinedLength = 8000
