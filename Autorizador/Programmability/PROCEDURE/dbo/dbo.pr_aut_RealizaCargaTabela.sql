...
Objeto: [dbo].[pr_aut_RealizaCargaTabela]
Propósito: Carga de tabelca cartao EMV
...
Chamado/Mudança: 402204 - 
--------------------------------------------------------------------------
Data criação: 23/08/2019
...
CREATE PROCEDURE [dbo].[pr_aut_RealizaCargaTabela](
			...
			BEGIN
				...
				BEGIN
					...
					SELECT 
						...
						,BinINI
						,BinFIM
					FROM EMV_Produtos WITH (NOLOCK) WHERE Ativo = 1
					ORDER BY Codigo ASC
